...
fn build_config_toml(base_url: &str, api_key: &str, protocol: RelayProtocol) -> String {
    ...
    [
        "model_provider = \"CodexAssistant\"".to_string(),
        String::new(),
        "[model_providers.CodexAssistant]".to_string(),
        "name = \"CodexAssistant\"".to_string(),
